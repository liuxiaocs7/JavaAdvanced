package com.liuxiaocs._09Properties属性集对象;
...
/**
     ...
     -- public void store(OutputStream out, String comments):保存数据到属性文件中去  字节流
     -- public void store(Writer fw, String comments):保存数据到属性文件中去  字符流
...
public class PropertiesDemo01 {
    public static void main(String[] args) throws Exception {
        ...
        OutputStream os = new FileOutputStream("Chapter10/src/users.properties");
        /**
         * 参数一：被保存数据的输出管道
         * 参数二：保存心得。就是对保存的数据进行解释说明
         */
        properties.store(os, "i am very happy!我快乐的保存了数据");
    }
}
